          ...
          <div class="card-content">
            <div class="content">
              ...
              <div class="field">
                ...
                />
                <p class="comment">
                  My story began on {{ selectedHero.originDate }}
                </p>
              </div>
              <div class="field">
...
const ourHeroes = [
  {
    ...
    lastName: 'Papa',
    capeCounter: 1,
    originDate: format(new Date(1994, 8, 2), inputDateFormat),
  ...
  },
  {
    ...
    lastName: 'Papa',
    capeCounter: 3,
    originDate: format(new Date(1994, 4, 2), inputDateFormat),
  ...
  },
  {
    ...
    lastName: 'Papa',
    capeCounter: 2,
    originDate: format(new Date(1998, 8, 2), inputDateFormat),
  ...
  },
  {
    ...
    lastName: 'Papa',
    capeCounter: 0,
    originDate: format(new Date(1999, 3, 2), inputDateFormat),
